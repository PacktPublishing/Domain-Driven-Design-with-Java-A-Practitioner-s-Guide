...
image::project-success-numbers.jpg[Project Statistics - By the numbers]
...
This chart below, derived from PMI's https://www.pmi.org/-/media/pmi/documents/public/pdf/learning/thought-leadership/pulse/pulse-of-the-profession-2017.pdf[__Pulse of the Profession__] report from 2017 highlights seems to highlight a very starking fact -- inaccurate or misinterpreted requirements cause a very large portion of projects to fail.
