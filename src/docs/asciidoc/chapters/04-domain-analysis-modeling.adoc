...
*Patrick* : _"When does the importer know about the LC being advised to the Exporter?"_ +
*Katie* : _"Good Question. The issuing bank notifies the importer about the LC being advised to the exporter via the advising bank". This concludes the issuance and advice flow for the LC._ +
