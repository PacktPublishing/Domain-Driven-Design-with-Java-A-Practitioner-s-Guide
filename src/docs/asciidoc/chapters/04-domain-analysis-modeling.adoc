...
*Actors* - Stories are communicated from the perspective of an actor(noun), who plays an active role in the context of the particular story. It is a good practice to use the ubiquitous language for the particular domain.
