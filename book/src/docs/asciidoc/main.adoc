...
include::{includedir}/04-domain-analysis-modeling.adoc[]

include::{includedir}/05-implementing-domain-logic.adoc[]

include::{includedir}/06-implementing-a-task-based-ui.adoc[]
