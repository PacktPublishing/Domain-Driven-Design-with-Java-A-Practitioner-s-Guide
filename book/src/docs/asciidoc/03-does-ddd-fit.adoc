...
Both architecture styles are synergistic with DDD's idea of developing the domain model for the core subdomain (and by extension its bounded context) independently of the rest of the system.

===== Clean architecture

.Clean architecture
[.text-center]
image::architecture-styles/clean.png[width=50%]
