...
skinparam ActivityFontName "Gloria Hallelujah"
skinparam ActivityFontSize 18
skinparam ActivityDiamondFontName "Gloria Hallelujah"
skinparam ActivityDiamondFontSize 18
skinparam NoteFontName "Gloria Hallelujah"
skinparam NoteFontSize 18
skinparam PartitionFontName "Gloria Hallelujah"
...
Mockito.verify(service).startNewLC("test-applicant", "12345");              // <3>
    }
}
....
