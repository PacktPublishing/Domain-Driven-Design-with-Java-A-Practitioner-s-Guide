...
An optional set of events may have occurred in the past. A command is received by the system, which acts as a stimulus. The system will react in one of two ways when it handles a command:
