...
import com.premonition.lc.ch09.domain.exceptions.*;
...
public class LCApplication {
    ...
    public void on(SubmitLCApplicationCommand command, DeadlineManager deadlineManager) {
        ...
        assertInDraft(state);
        deadlineManager.schedule(LC_APPROVAL_REMINDER_THRESHOLD, LC_APPROVAL_PENDING_REMINDER, LCApprovalPendingNotification.first(id));
