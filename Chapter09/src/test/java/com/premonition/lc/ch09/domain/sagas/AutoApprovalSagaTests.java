package com.premonition.lc.ch09.domain.sagas;
...
import com.premonition.lc.ch09.domain.commands.ApproveLCApplicationCommand;
import com.premonition.lc.ch09.domain.events.inbound.ApplicantCreditValidatedEvent;
import com.premonition.lc.ch09.domain.events.inbound.ProductLegalityValidatedEvent;
import com.premonition.lc.ch09.domain.events.inbound.ProductValueValidatedEvent;
import com.premonition.lc.ch09.domain.events.outbound.LCApplicationApprovedEvent;
import com.premonition.lc.ch09.domain.events.outbound.LCApplicationSubmittedEvent;
...
class AutoApprovalSagaTests {
    ...
    class LifeCycleTests {
        ...
        private static Stream<Arguments> autoApprovalThreshold() {
            return Stream.of(
                    Arguments.of(AutoApprovalSaga.AUTO_APPROVAL_THRESHOLD_AMOUNT.subtract(ONE_DOLLAR), "lesser than"),
                    Arguments.of(AutoApprovalSaga.AUTO_APPROVAL_THRESHOLD_AMOUNT, "equal to")
            );
        }
        ...
        void shouldEndSagaImmediatelyIfAmountGreaterThanAutoApprovalThreshold() {
            ...
            fixture.givenNoPriorActivity()
                    .whenPublishingA(
                            new LCApplicationSubmittedEvent(lcApplicationId, AutoApprovalSaga.AUTO_APPROVAL_THRESHOLD_AMOUNT.add(ONE_DOLLAR)))
                    .expectActiveSagas(0);
        }
    }
}